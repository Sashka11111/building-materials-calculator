...
public class CategoryService {
  ...
  public static void addCategory() {
    ...
    do {
      ...
      if (!CategoryValidator.isCategoryIdUnique(categories, newCategoryId)) {
    ...
    do {
      ...
      if (!UserValidator.isNotEmpty(name)) {
        System.out.println("Категорія не може бути порожньою.");
      } else if (!CategoryValidator.isValidCategoryName(name)) {
        System.out.println("Категорія повинна бути до 50 символів.");
      } else if (!CategoryValidator.isCategoryNameUnique(categories, name)) {
